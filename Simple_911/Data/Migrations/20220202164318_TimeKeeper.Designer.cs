...
namespace Simple_911.Data.Migrations
{
    ...
    [Migration("20220202164318_TimeKeeper")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Simple_911.Models.TimeKeeper", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<DateTimeOffset?>("TAssist")
                        .HasColumnType("timestamp with time zone");

                    b.Property<DateTimeOffset>("TCreated")
                        .HasColumnType("timestamp with time zone");

                    b.Property<DateTimeOffset?>("TDispatched")
                        .HasColumnType("timestamp with time zone");

                    b.Property<DateTimeOffset?>("TEnroute")
                        .HasColumnType("timestamp with time zone");

                    b.Property<DateTimeOffset?>("THospital")
                        .HasColumnType("timestamp with time zone");

                    b.Property<DateTimeOffset?>("TInService")
                        .HasColumnType("timestamp with time zone");

                    b.Property<DateTimeOffset?>("TOOS")
                        .HasColumnType("timestamp with time zone");

                    b.Property<DateTimeOffset?>("TOnscene")
                        .HasColumnType("timestamp with time zone");

                    b.Property<DateTimeOffset?>("TTransporting")
                        .HasColumnType("timestamp with time zone");

                    b.HasKey("Id");

                    b.ToTable("TimeKeeper");
                });
            ...
            modelBuilder.Entity("Simple_911.Models.Incident", b =>
                {
                    ...
                    b.HasOne("Simple_911.Models.TimeKeeper", "TimeKeeper")
                        .WithMany()
